...
channel_id = 'UCYfJG6cGfW84FVLuy7semEg'#频道ID  Command + Option + U
################################################################################################################################
...
class YoukuCrawler:
 ...
 ########################################################################################################################################################
        first_url = base_search_url + 'key={}&channelId={}&part=snippet,id&publishedAfter=2020-04-20T00:00:00Z&publishedBefore=2020-04-27T00:00:00Z&order=date&maxResults=25'.format(self.app_key, channel_id)
########################################################################################################################################################
        url = first_url
...
########################################################################################################################################################
                    if (otherStyleTime>='2020-06-20' and otherStyleTime<="2020-06-27"):
########################################################################################################################################################
